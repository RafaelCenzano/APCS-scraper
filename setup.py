...
setup(
    ...
    description='Python app to scrape and remove links that return 404',
    ...
    # Author's contact
    author_email='contact@rafaelcenzano.com',

    # Maintainer's name
    maintainer='Rafael Cenzano',

    # Maintainer's email
    maintainer_email='contact@rafaelcenzano.com',

    # Project's home page
    url='https://github.com/RafaelCenzano/APCS-scraper',
